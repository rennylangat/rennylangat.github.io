...
export class AboutRenny extends Component {
  constructor() {
    super();
    this.screens = {};
    this.state = {
...
export default AboutRenny;

export const displayAboutRenny = () => {
  return <AboutRenny />;
};
  ...
  return (
    <>
      ...
      <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
        <div>
          my name is <span className="font-bold">Renny Langat</span> ,
        </div>
        <div className="font-normal ml-1">
          I'm a{" "}
          <span className="text-pink-600 font-bold">Mobile Developer!</span>
        </div>
      </div>
      ...
      <ul className=" leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc">
          ...
          <span className=" font-medium">based in Kenya</span> currently working
          at nGeni IO,{" "}
          <a href="https://www.ngeni.io/" rel="noreferrer" target="_blank">
            a software company based in Nairobi, Kenya
          </a>
          .
        </li>
        <li className=" mt-3 list-building">
          {" "}
          I enjoy building beautiful cross-platform apps that solve practical
          problems.
        </li>
        <li className=" mt-3 list-time">
          {" "}
          When I am not coding my next project, I like to spend my time reading
          books, cooking or listening to{" "}
          <a
            href="https://podcasts.google.com/feed/aHR0cHM6Ly9mZWVkcy5tZWdhcGhvbmUuZm0vYWRsODI4ODI5MzExNQ"
            target="_blank"
            rel="noreferrer"
          >
            {" "}
            the concerned citizen's podcasts.
          </a>
        </li>
        <li className=" mt-3 list-star">
          {" "}
          And I also have interest in Blockchain Development!
        </li>
      </ul>
    </>
  );
    ...
    <>
      ...
      <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
        ...
        <li className="list-disc mt-5">
          <div className=" text-lg md:text-xl text-left font-bold leading-tight">
            eMobilis Training Institue
          </div>
          <div className=" text-sm text-gray-400 mt-0.5">
            2016 January - 2016 July
          </div>
          <div className=" text-sm md:text-base">
      ...
      <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
        <div className="px-2 w-1/2">
          <div className="flex flex-wrap justify-center items-start w-full mt-2">
            ...
            <img
              className="m-1"
              src="https://img.shields.io/badge/Kotlin-E97C2C?style=flat&logo=kotlin&logoColor=#E97C2C"
              alt="renny dart"
            />
            <img
              className="m-1"
            ...
            <img
              className="m-1"
              src="http://img.shields.io/badge/-Java-F89916?style=flat&logo=java&logoColor=5283A2"
              alt="renny java"
            />
            <img
              className="m-1"
              src="http://img.shields.io/badge/-Solidity-363636?style=flat&logo=solidity&logoColor=5283A2"
              alt="renny java"
            />
            <img
              className="m-1"
              src="http://img.shields.io/badge/-Typescript-2F74C0?style=flat&logo=typescript&logoColor=FFFFFF"
              alt="renny java"
            />
            <a
        ...
        <div className="px-2 flex flex-wrap items-start w-1/2">
          <div className="flex flex-wrap justify-center items-start w-full mt-2">
            ...
            <img
              className="m-1"
              src="https://img.shields.io/badge/Compose-02569B?style=flat&logo=kotlin&logoColor=E97C2C"
              alt="vivek flutter"
            />
            <img
              className=" m-1"
...
function Projects() {
  const project_list = [
    {
      name: "Wabebe Car Pooling Application",
      date: "Mar 2021",
      link: "https://appgallery.huawei.com/app/C104025005",
      description: [
        "An Android Application that allows for car pooling and even same gender car pooling!",
      ],
      domains: ["android", "java"],
    },
    {
      name: "Recognition of Prior Learning",
      date: "July 2021",
      link: "https://github.com/rennylangat/knqa-app",
      description: [
        "A Flutter & Spring application that allows for persons with no formal education to get certified and recognized for their skillset",
      ],
      domains: ["flutter", "spring", "dart", "MySQL"],
    },
    {
      name: "Phindor Business Assistant",
      date: "April 2021",
      link: "https://github.com/rennylangat/PhindorV2",
      description: [
        "A flutter application that allows a business owner to manage their business and use its statistics to make decisions",
      ],
    ...
    },
    {
      name: "NFT Market",
      date: "Jul 2021",
      link: "https://github.com/rennylangat/NftMarket",
      description: [
        "A flutter application that allows users to buy and sell art using Non-Fungible Tokens.",
      ],
      domains: ["flutter", "web3", "dart", "node js"],
    },
    // {
...
function Resume() {
  return (
    <iframe
      ...
      src="./files/RESUME-RENNY-LANGAT.pdf"
      title="Renny Langat resume"
      frameBorder="0"
    ></iframe>
  );
}
